...
template <> constexpr inline auto MonitorService::qt_create_metaobjectdata<qt_meta_tag_ZN14MonitorServiceE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const ServerHealth &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'newEvent'
...
void MonitorService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->healthUpdated((*reinterpret_cast<std::add_pointer_t<ServerHealth>>(_a[1]))); break;
        case 1: _t->newEvent((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->start(); break;
        case 3: _t->checkNow(); break;
        case 4: _t->onReplyFinished(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MonitorService::*)(const ServerHealth & )>(_a, &MonitorService::healthUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MonitorService::*)(const QString & )>(_a, &MonitorService::newEvent, 1))
            return;
    }
}
...
// SIGNAL 0
void MonitorService::healthUpdated(const ServerHealth & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void MonitorService::newEvent(const QString & _t1)
{
