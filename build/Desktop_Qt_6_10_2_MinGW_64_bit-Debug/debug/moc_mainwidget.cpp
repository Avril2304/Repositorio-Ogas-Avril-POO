...
template <> constexpr inline auto MainWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'updateTask'
        QtMocHelpers::SlotData<void(Task)>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
        // Slot 'deleteTask'
...
void MainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->openAddTaskForm(); break;
        case 2: _t->addTask((*reinterpret_cast<std::add_pointer_t<Task>>(_a[1]))); break;
        case 3: _t->updateTask((*reinterpret_cast<std::add_pointer_t<Task>>(_a[1]))); break;
        case 4: _t->deleteTask((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->openEditTaskForm((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->openNotes((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
